...
**Plan 1–5、Oracle 0.2 软件信任门、安全 `.mxl`、Plan 6A、producer-driven MusicXML/IR 与
strict MIDI input 已闭门；MIDI 的 local/tracking/remote receipt 均为 `46ff8ac`。当前进入 benchmark v2。**
...
见 [`docs/MIDI_ACCEPTANCE.md`](docs/MIDI_ACCEPTANCE.md)。benchmark v2 将先冻结版本化 corpus、
manifest、逐项 rows、统计与 replay，再重跑当前模型；详见
