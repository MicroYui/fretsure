...
def test_arrangement_wire_stamps_actual_model_and_all_public_contracts(
    ...
    assert stamps["oracle_checker_version"] == "oracle@0.8.0"
    ...
    assert stamps["score_solver_version"] == "score-solver@0.7.0"
...
def test_capabilities_wire_is_transport_neutral_and_honest() -> None:
    ...
    assert wire["stamps"]["fingering_solver_version"] == "fingering-solver@0.7.0"  # type: ignore[index]
    assert wire["stamps"]["score_solver_version"] == "score-solver@0.7.0"  # type: ignore[index]
