...
fresh attempt-004 绑定与 detached 正式采集。live throughput pilot 已在 pushed commit
...
4 路 ETA 为乐观 35:29 / 中位 41:14 / 合并速率 44:33 / 保守 67:22。现有 pre-call、WAL、
config、abort receipt 与金额均为冻结历史证据。
