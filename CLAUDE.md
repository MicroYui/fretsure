...
**当前恢复真源（2026-07-30）**：`oracle@0.8.0` / `median@0.3`，曲目门 **149/292 = 51.0%**
（GREEN 114），冻结基线 30/56，**帧级假阴性 3.3%**、判别力 96.7 点。上一版记的 146/292
复现不出来——同一 commit 干净树跑两次都是 107，`--choose-capo` 在 56 首上只多救 1 首，
来源无法重建，故**改正**。**没人能重新签发的数字不是基线**：曲目门一臂近 30 分钟，
于是它被跨会话凭记忆引用。
