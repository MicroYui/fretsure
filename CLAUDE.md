...
**语料里有 19 首曲子的音高吉他根本发不出来**（07-31，`scripts/audit_corpus_range.py`）：
...
**物理模型作为曲目门改进来源已经关掉了**（07-31）。剔掉那 19 首后：149 接受、124 首被拒
= **40 帧级配置**（已关闭，17 帧几何、中位裕度 21.3 mm）+ **84 beam**。帧级配置那 44 帧重新归因：19 几何（裕度 3.4 / 21.3 / 67.2 mm）、
