...
**当前数字，`oracle@0.7.0` / `median@0.3`，全部于 2026-07-30 重测：**

```
曲目门        152 / 292 = 52.1%      GREEN 118 · AMBER 34 · INFEASIBLE 140
冻结基线      30 / 56
帧级假阴性     9.8%（全语料 246 帧）/ 3.3%（test 30 帧）
判别力         90.2 个百分点（全语料）
负样本守卫     RED 1449 · AMBER 188 · GREEN 81，invariant_held
```
