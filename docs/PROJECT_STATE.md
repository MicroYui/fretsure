...
`data/score_corpus/` 的 58 首有许可的出版古典吉他谱（人类弹了两百年）上，**完全不含 LLM** 的
...
里程碑已闭门，验收见 [`REPERTOIRE_MILESTONE_ACCEPTANCE.md`](REPERTOIRE_MILESTONE_ACCEPTANCE.md)。完整计划见会话计划文件；实测与决策记录见
