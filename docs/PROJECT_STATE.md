...
> 目的：任何新会话读完本文件 + 设计 spec，即可无损接上。最后更新：2026-07-29。
...
```
曲目门        146 / 292 = 50.0%      GREEN 89 · AMBER 57 · INFEASIBLE 146
帧级假阴性     15.0%（全语料 246 帧）/ 6.7%（test 30 帧）
判别力         85.0 个百分点（全语料）/ 93.3（test）
负样本守卫     RED 1648 · AMBER 45 · GREEN 25，invariant_held
```
