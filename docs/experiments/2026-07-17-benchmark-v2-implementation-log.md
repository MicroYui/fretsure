...
### Attempt-004 live 95% checkpoint after the network retest

Canonical post-retest operator sequence 271 recorded exactly 95% after 187,013.206876 active
segment seconds: 9,557/10,060 network units, 10,060/10,563 total rows, and 42,820 completed
calls. The 3,789-unit resume prefix means this segment had durably added 5,768 units and
28,588 calls. Overall/recent-15-minute segment throughput was 111.033869/124.0 units/hour and
550.318353/660.0 calls/hour. The record was not stalled and reported 14,604 optimistic and
16,309 median/conservative seconds remaining, approximately 4 hours 3 minutes through 4
hours 32 minutes. Its exact canonical line SHA-256 is
`f57129e6229c3774a8a0379a975e2febd487b1b2fb8410ae5bb0703cdf43ab0a`.

The subsequent read-only snapshot had 9,654 `UNIT_ADMITTED` and 9,650 `UNIT_READY` events,
corresponding to 10,153 rows and 43,320 completed calls (95.92%). Lane event types were
43,809/43,805 attempt intent/result and 43,324/43,320 call intent/result; the content-free
extra-attempt count was 485, with four currently active boundaries. PID and detached
`screen` were healthy, and no terminal, abort, or canonical marker existed. Only progress
metadata and aggregate event types were inspected; the execution binding, private payloads,
and frontend remained untouched.

### Attempt-004 live 90% checkpoint after the network retest

Canonical post-retest operator sequence 249 recorded exactly 90% after 172,044.575825 active
segment seconds: 9,054/10,060 network units, 9,557/10,563 total rows, and 40,262 completed
calls. The 3,789-unit resume prefix means this segment had durably added 5,265 units and
26,030 calls. Overall/recent-15-minute segment throughput was 110.169123/140.0 units/hour and
544.672795/548.0 calls/hour. The record was not stalled and reported 25,869 optimistic and
32,874 median/conservative seconds remaining, approximately 7 hours 11 minutes through 9
hours 8 minutes. Its exact canonical line SHA-256 is
`01e7e4804c00e2e5e5514fc92555e5ff53717ecf99f1a1a9acfb8fd7e539dbd3`.

The subsequent read-only snapshot had 9,176 `UNIT_ADMITTED` and 9,172 `UNIT_READY` events,
corresponding to 9,675 rows and 40,888 completed calls (91.17%). Lane event types were
41,374/41,371 attempt intent/result and 40,891/40,888 call intent/result; the content-free
extra-attempt count was 483, with three currently active boundaries. PID and detached
`screen` were healthy, and no terminal, abort, or canonical marker existed. Only progress
metadata and aggregate event types were inspected; the execution binding, private payloads,
and frontend remained untouched.

### Attempt-004 live 85% checkpoint after the network retest

Canonical post-retest operator sequence 230 recorded exactly 85% after 157,643.337365 active
segment seconds: 8,551/10,060 network units, 9,054/10,563 total rows, and 37,795 completed
calls. The 3,789-unit resume prefix means this segment had durably added 4,762 units and
23,563 calls. Overall/recent-15-minute segment throughput was 108.746746/128.0 units/hour and
538.093150/736.0 calls/hour. The record was not stalled and reported 42,441 optimistic and
49,955 median/conservative seconds remaining, approximately 11 hours 47 minutes through 13
hours 53 minutes. Its exact canonical line SHA-256 is
`94d5d9458af7f6e1b01ad33dab4e46292c3898fd746e599e0d171c5feec94aa2`.

The subsequent read-only snapshot had 8,650 `UNIT_ADMITTED` and 8,646 `UNIT_READY` events,
corresponding to 9,149 rows and 38,316 completed calls (85.94%). Lane event types were
38,801/38,797 attempt intent/result and 38,320/38,316 call intent/result; the content-free
extra-attempt count was 481, with four currently active boundaries. PID and detached
`screen` were healthy, and no terminal, abort, or canonical marker existed. Only progress
metadata and aggregate event types were inspected; the execution binding, private payloads,
and frontend remained untouched.

### Attempt-004 live 80% checkpoint after the network retest

Canonical post-retest operator sequence 209 recorded exactly 80% after 142,757.441174 active
segment seconds: 8,048/10,060 network units, 8,551/10,563 total rows, and 35,295 completed
calls. The 3,789-unit resume prefix means this segment had durably added 4,259 units and
21,063 calls. Overall/recent-15-minute segment throughput was 107.401757/120.0 units/hour and
531.158302/568.0 calls/hour. The record was not stalled and reported 60,360 optimistic and
67,441 median/conservative seconds remaining, approximately 16 hours 46 minutes through 18
hours 44 minutes. Its exact canonical line SHA-256 is
`968fa100cd5919b646696118d16bfbd7815462e5e325fa1063ec444c14185bba`.

The subsequent read-only snapshot had 8,157 `UNIT_ADMITTED` and 8,153 `UNIT_READY` events,
corresponding to 8,656 rows and 35,808 completed calls (81.04%). Lane event types were
36,293/36,289 attempt intent/result and 35,812/35,808 call intent/result; the content-free
extra-attempt count was 481, with four currently active boundaries. PID and detached
`screen` were healthy, and no terminal, abort, or canonical marker existed. Only progress
metadata and aggregate event types were inspected; the execution binding, private payloads,
and frontend remained untouched.

### Attempt-004 live 75% checkpoint after the network retest

Canonical post-retest operator sequence 184 recorded exactly 75% after 125,822.208924 active
segment seconds: 7,545/10,060 network units, 8,048/10,563 total rows, and 32,931 completed
calls. The 3,789-unit resume prefix means this segment had durably added 3,756 units and
18,699 calls. Overall/recent-15-minute segment throughput was 107.465924/120.0 units/hour and
535.012066/540.0 calls/hour. The record was not stalled and reported 75,450 optimistic and
84,250 median/conservative seconds remaining, approximately 20 hours 58 minutes through 23
hours 24 minutes. Its exact canonical line SHA-256 is
`b30ebed0ce517bd90ec422228d809da7ad39225ea2652435092f1bcc1ea11a7f`.

The subsequent read-only snapshot had 7,613 `UNIT_ADMITTED` and 7,609 `UNIT_READY` events,
corresponding to 8,112 rows and 33,224 completed calls (75.64%). Lane event types were
33,704/33,700 attempt intent/result and 33,228/33,224 call intent/result; the content-free
extra-attempt count was 476, with four currently active boundaries. PID and detached
`screen` were healthy, and no terminal, abort, or canonical marker existed. Only progress
metadata and aggregate event types were inspected; the execution binding, private payloads,
and frontend remained untouched.

### Attempt-004 live 70% checkpoint after the network retest

Canonical post-retest operator sequence 158 recorded exactly 70% after 108,099.287072 active
segment seconds: 7,042/10,060 network units, 7,545/10,563 total rows, and 30,336 completed
calls. The 3,789-unit resume prefix means this segment had durably added 3,253 units and
16,104 calls. Overall/recent-15-minute segment throughput was 108.333739/108.0 units/hour and
536.306960/552.0 calls/hour. The record was not stalled and reported 100,291
optimistic/median and 100,600 conservative seconds remaining, approximately 1 day 3 hours
51 minutes through 1 day 3 hours 57 minutes. Its exact canonical line SHA-256 is
`78e172c4f2cecca60fd691837481f0968ced4b0a1cb234313b0a440056b587d5`.

The subsequent read-only snapshot had 7,092 `UNIT_ADMITTED` and 7,088 `UNIT_READY` events,
corresponding to 7,591 rows and 30,600 completed calls (70.46%). Lane event types were
31,073/31,069 attempt intent/result and 30,604/30,600 call intent/result; the content-free
extra-attempt count was 469, with four currently active boundaries. PID and detached
`screen` were healthy, and no terminal, abort, or canonical marker existed. Only progress
metadata and aggregate event types were inspected; the execution binding, private payloads,
and frontend remained untouched.
